...
public:  // interface
  ...
  bool operator()(const pat::Jet &jet, pat::strbitset &ret) override {
    if (version_ == FIRSTDATA || version_ == RUNIISTARTUP || version_ == WINTER16 || version_ == WINTER17 ||
        ...
        version_ == RUN2UL16PUPPI || version_ == RUN3WINTER22CHSrunsBCDEprompt || version_ == RUN3WINTER22PUPPIrunsBCDEprompt || 	 version_ == RUN3WINTER22CHS || version_ == RUN3WINTER22PUPPI ||
  ...
  bool firstDataCuts(reco::Jet const &jet, pat::strbitset &ret, Version_t version_) {
    ...
    if ((version_ != WINTER17 && version_ != WINTER17PUPPI && version_ != SUMMER18 && version_ != SUMMER18PUPPI &&
         ...
         version_ != RUN3WINTER22PUPPIrunsBCDEprompt && version_ != RUN3WINTER22CHS &&
         version_ != RUN3WINTER22PUPPI && version_ != RUN2ULCHS && version_ != RUN2ULPUPPI) ||
        quality_ != TIGHT) {
    ...
    } else if ((version_ == SUMMER18) || (version_ == RUN2ULCHS) || (version_ == RUN3WINTER22CHSrunsBCDEprompt) || (version_ == RUN3WINTER22CHS)) {
    ...
    else if ((version_ == SUMMER18PUPPI) || (version_ == RUN2ULPUPPI) || (version_ = RUN3WINTER22PUPPIrunsBCDEprompt)|| (version_ = RUN3WINTER22PUPPI)) {
...
private:  // member variables
  void initCuts() {
    ...
    if ((version_ == SUMMER18) || (version_ == RUN2ULCHS) || (version_ == RUN3WINTER22CHSrunsBCDEprompt) || (version_ == RUN3WINTER22CHS)) 
   {
      push_back("NHF_TR");
      push_back("NEF_TR");
      push_back("NCH_TR");
    ...
    if ((version_ == SUMMER18PUPPI) || (version_ == RUN2ULPUPPI) || (version_ == RUN3WINTER22PUPPIrunsBCDEprompt) || (version_ == RUN3WINTER22PUPPI)) {
      push_back("NHF_TR");
      push_back("NEF_TR");
      push_back("NHF_EC");
      push_back("NEF_FW");
    ...
    if (quality_ == LOOSE) {
      ...
      if (version_ != WINTER17 && version_ != WINTER17PUPPI && version_ != SUMMER18 && version_ != SUMMER18PUPPI &&
          version_ != RUN2UL16CHS && version_ != RUN2UL16PUPPI && version_ != RUN2ULCHS && version_ != RUN2ULPUPPI &&
          version_ != RUN3WINTER22CHSrunsBCDEprompt && version_ != RUN3WINTER22PUPPIrunsBCDEprompt  && version_ != RUN3WINTER22CHS && version_ != RUN3WINTER22PUPPI)
        set("CEF", 0.99);
      if (version_ == RUN3WINTER22CHSrunsBCDEprompt || version_ == RUN3WINTER22PUPPIrunsBCDEprompt  || version_ == RUN3WINTER22CHS || version_ == RUN3WINTER22PUPPI)
        set("CHF", 0.01);
